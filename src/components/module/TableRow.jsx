...
export const TableRow = ({ coin }) => {
  ...
  return (
    <tr className="transition-colors hover:bg-[#51445f]">
      ...
      <td className="whitespace-nowrap px-6 py-4 text-left text-[14px] text-neutral-300 font-semibold uppercase tracking-wider">{name}</td>
      <td className="whitespace-nowrap px-6 py-4 text-center text[14px] text-neutral-300 font-semibold uppercase tracking-wider ">${current_price.toLocaleString()}</td>
